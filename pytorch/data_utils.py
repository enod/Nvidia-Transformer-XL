...
class Corpus(object):
    def __init__(self, path, dataset, vocab, *args, **kwargs):
        ...
        if self.dataset in ['ptb', 'wt2', 'wt103', 'mn_dataset']:
    ...
    def get_iterator(self, split, *args, **kwargs):
        if split == 'train':
            if self.dataset in ['ptb', 'wt2', 'wt103', 'enwik8', 'text8', 'mn_dataset']:
...
def get_lm_corpus(datadir, dataset, vocab):
    ...
    if os.path.exists(fn):
        ...
        kwargs = {}
        if dataset in ['wt103', 'wt2', 'mn_dataset']:
            kwargs['special'] = ['<eos>']
